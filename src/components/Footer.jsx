    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-left">
          <h2 className="mt-neg-10px mb-0 mb-10px fs-2-5rem fw-bold text-primary">TEST BASE SOLUTIONS LTD</h2>
          <a href="https://www.linkedin.com/company/testbasesolutions-ltd/?originalSubdomain=uk" target="_blank" rel="noreferrer" className="footer-contact-link no-decoration color-inherit">
            ...
            <span className="fs-0-8rem ls-1px">LinkedIn: Test Base Solutions Ltd</span>
          </a>

          <a href="tel:+4407918107720" className="footer-contact-link no-decoration color-inherit">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span className="fs-0-8rem ls-1px">+44 (0) 7918 107720</span>
          </a>
          ...
          <a href="mailto:info@testbasesolutions.co.uk" className="footer-contact-link no-decoration color-inherit">
            ...
            <span className="fs-0-8rem ls-1px">info@testbasesolutions.co.uk</span>
          </a>
        </div>
